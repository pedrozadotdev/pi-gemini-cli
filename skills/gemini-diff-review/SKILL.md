...
gemini "Review the code changes at gemini-review.diff for issues. Do not make any changes. Respond with feedback only." -m gemini-3.1-pro-preview -o text 2>&1
...
gemini "Review gemini-review.diff. Do not make any changes. Respond with feedback only." -m gemini-3.1-pro-preview -o text 2>&1
rm gemini-review.diff
```
...
gemini "Review the commit at gemini-review.diff. Do not make any changes. Respond with feedback only." -m gemini-3.1-pro-preview -o text 2>&1
rm gemini-review.diff
```
...
to understand the broader context. Do not make any changes. Respond with feedback only." -m gemini-3.1-pro-preview -o text 2>&1
rm gemini-review.diff
```
